                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                  fontSize: 15,
                                  color: activeMenu1 == index ? KColors.primary : KColors.grey,
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                  fontSize: 15,
                                  color: activeMenu2 == index ? KColors.primary : KColors.grey,
                                  fontWeight: FontWeight.w600),
                            ),
                            SizedBox(
                              height: 3,
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    image: DecorationImage(
                                        image:
                                            AssetImage(songs[index + 5]['img'] as String),
                                        fit: BoxFit.cover),
                                    color: KColors.primary,
                                    borderRadius: BorderRadius.circular(10)),
                              ),
                              ...
                              Container(
                                width: 180,
                                child: Text(
                                  songs[index + 5]['description'] as String,
                                  maxLines: 1,
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      fontSize: 12,
